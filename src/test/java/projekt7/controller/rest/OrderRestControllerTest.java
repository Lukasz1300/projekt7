...
public class OrderRestControllerTest {
    ...
    public void setup() {
        ...
        order.setAddressCity("Test Delivery Address");
    ...
    public void testGetAllOrders() throws Exception {
        mockMvc.perform(get("/api/orders")
                ...
                .andExpect(jsonPath("$[0].addressCity", is(order.getAddressCity()))); // Sprawdza adres dostawy
    }
    ...
    public void testCreateOrder() throws Exception {
        ...
        differentRestaurant.setAddressCity("Warszawa");
        differentRestaurant.setAddressStreet("78 Another Street");
        ...
        newOrder.setAddressCity("45 Different Street, Another City");
