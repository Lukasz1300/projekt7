...
public class CategoryControllerIntegrationTest {
    ...
    public void testSaveCategory() throws Exception {
        ...
        mockMvc.perform(post("/categories") // Tworzy żądanie POST do endpointu "/categories"
                ...
                .andExpect(redirectedUrl("/categories/list")); // Sprawdza, czy przekierowano do "/categories"
    ...
    public void testDeleteCategory() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/categories/delete/{id}", categoryId)
                ...
                .andExpect(redirectedUrl("/categories/list")); // Oczekuje, że zostanie przekierowane na /categories
